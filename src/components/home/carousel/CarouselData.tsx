...
export const CarouselData = [
  ...
  },
  {
    line: lines1,
    label: "ALL TIME FAVOURITE",
    title: "Indulgence in every bite, a moment of pure decadence.",
    imgs: [{ id: 1, img: carouselc1 }],
  },
  {
    line: lines1,
    label: "ALL TIME FAVOURITE",
    title: "In the realm of desserts, flavors dance and emotions awaken.",
    imgs: [{ id: 1, img: carouseld1 }],
  },
];

export const crouselcomponents = [GiftBox, CategoriesPage];
