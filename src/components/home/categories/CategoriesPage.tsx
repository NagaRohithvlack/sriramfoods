...
function CategoriesPage () {
  ...
  <div className="grid grid-cols-2 md:grid md:grid-cols-4 justify-center gap-4 md:gap-4 md:w-full max-w-[900px]">
    {CategoriesData.map((item) => (
      <div key={item.id} className="w-full p-8 md:p-4 flex flex-col justify-center items-center gap-2 md:gap-4" style={{ backgroundColor: item.color, borderRadius: '130px 10px 10px 10px' }} > 
