...
export default function GiftBoxPage() {
  return (
    <>
      <BorderLineUp />
      <div className="flex flex-col gap-24 md:flex-row  md:gap-4 items-center justify-center bg-[#FFD285] py-24 md:px-24 px-5">
        <div className="flex items-center relative justify-center w-full md:w-3/6">
          <img src={GiftBox} className=" absolute left-[30px] -bottom-10" />
          <img src={GiftBoxBackground} alt="" className=" " />
        </div>
        ...
        <div className="flex flex-col gap-y-6 w-full md:w-3/6 lg:w-4/6">
          ...
          <p className="text-base">
            ...
            Authentic India. From lavish kaju sweets, to pure ghee delicacies
            and freshly made savories, every morsel is imagined and created with
            a single intent, to deliver joy.
          </p>
        </div>
      </div>
      <BorderLineDown />
