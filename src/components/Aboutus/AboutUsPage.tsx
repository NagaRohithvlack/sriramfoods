    ...
    return (
        <div className="flex flex-col justify-center items-center md:gap-12 h-screen md:flex md:flex-row bg-[#FFF6F1]">
            ...
            <div className="md:w-3/6  md:flex-row flex  relative  md:h-5/6 ">
                ...
                <div className=" absolute bottom-2 right-4 md:h-3/6 md:w-3/6 border-[16px] border-white" >
                    <img src={AboutUsData[0].img2} className="h-full w-full object-cover object-center" />
                </div>
                </div>
            ...
            <div className="content md:w-3/6 md:flex md:flex-col md:gap-8">
                ...
                <p className="font-light text-semibold">{AboutUsData[0].content}</p>
