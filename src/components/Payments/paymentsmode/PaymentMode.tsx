            ...
            <form className="flex flex-col gap-8">
                <div className="">
                    ...
                    <div className=" flex items-center gap-4">
                        ...
                        <img src={visa} alt="visa" className=" w-[80px] "/>
                        <img src={rupay} alt="rupay" className=" w-[80px] "/>
                        <button type="submit" className="h-[50px] bg-[#f7f7f7] px-4 ">See More</button>
                    </div>
                    <div className="flex gap-4 pl-2">
                        <img src={creditcard} alt="cardimg" className="w-[70px]"/>
