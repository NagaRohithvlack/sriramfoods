...
import BorderLine from "../../home/shop/BorderLine";

function SpecialPageBanner() {
    return (
        <div>
        <div className="relative w-full md:h-[437px]">
  
  <div className="diva w-full h-full border border-slate-900 relative">
    <img src={specialsimg} alt="" className="w-full h-full absolute inset-0 object-cover" />
  </div>
